#binary classifier Attempt 2, 80/20/test split - added handness to vector
...
#load dataset
df = pd.read_csv("../training-data/dataset/dataset_norm1.csv",dtype=np.float32)
dataset = df.to_numpy()
#all rows, -1 cols
X = dataset[:,0:64]
#all rows, last col
...
model.summary()
model.save(filepath='../model/gestureClassifierV1/v05/model.h5',)