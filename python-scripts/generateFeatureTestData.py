...
alberto_thumbsup_data = get_feature_data_from_images("../test-images/alberto/thumbs-up","Left",0,1)
print("alberto thumbs up")
print(len(alberto_thumbsup_data))

susana_thumbsup_data = get_feature_data_from_images("../test-images/susana/thumbs-up","Left",0,1)
print("susana thumbs up")
print(len(susana_thumbsup_data))

lorena_thumbsup_data = get_feature_data_from_images("../test-images/lorena/thumbs-up","Left",0,1)
...
#get data from video
nongesture_data = get_feature_data("../test-videos/nongesture",frame_ranges_ng,0)
print("non gesture")
...
if len(dataset)>0:
    ...
    dataset_df.to_csv("../test-data/dataset/test_dataset_feature0.csv",index=False)