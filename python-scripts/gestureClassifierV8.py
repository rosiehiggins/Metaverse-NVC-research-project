#multi class, attempted to improved dataset for raise hand
#implemented early stopping
#removed a third layer as it doesn't seem to improve it
...
#load dataset
df = pd.read_csv("../training-data/dataset/dataset_multiclass_features5.csv",dtype=np.float32)
...
model.summary()
model.save(filepath='../model/gestureClassifier/v15/model.h5',)